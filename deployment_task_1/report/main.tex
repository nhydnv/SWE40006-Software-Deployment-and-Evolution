...
All four subtasks 1.1, 1.2, 1.3, and 1.4 were attempted.
...
The first step was creating a new C\# project, adding the provided code, and building it in Release mode.
...
The WiX toolset was installed using the CLI.
...
The WiX project and source file were manually created. The \texttt{.wxs} file was then configured to contain instructions to build the installer.
...
The application \texttt{subtask\_1} is finally uninstalled.
